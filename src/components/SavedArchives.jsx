...
export default function SavedArchives({ onLoad }) {
    ...
    const calculatorArchives = filteredArchives.filter(a => a.type === 'calculator');
    const scheduleArchives = filteredArchives.filter(a => a.type === 'schedule');
                            ...
                            <section>
                                ...
                                {calculatorArchives.length === 0 ? (
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                        {calculatorArchives.map((archive) => {
